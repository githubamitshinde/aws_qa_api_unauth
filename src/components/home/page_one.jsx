...
class PageOne extends Component {
        ...
        EventMapper.validate_redirection(page_index)
            .then(function () {
                ...
                if (sessionStorage.getItem('google_acc_id') != 'null') {
                    ReactGA.initialize(sessionStorage.getItem('google_acc_id'));    //'UA-130680337-1'
                    ReactGA.pageview(ApiList.current.ui_url + window.location.pathname + window.location.search);
                }
    ...
    render() {
        ...
        console.log('kill', tokenGlobal);
        console.log('killbill', tokenGlobalAfficient)
        // GTM-TKWTV73
        // sessionStorage.setItem('container_id', 'GTM-NS7999K');
                    ...
                    <div id="income_s" className="col-md-12 text-center section" style={{ backgroundColor: '#F9E038' }}>
                        <div className="container">
                            <div className="col-md-12 mt2">
                                <span className="fgsd14" id="121"></span>
                            </div>
                            <div className="col-md-12">
                                <h1 className="agendabold42" id="122"></h1>
                            </div>
                            <div className="col-md-8 col-md-offset-2">
                                <h4 className="ltr20" id="123"></h4>
                            </div>
                            ...
                            <div className="col-md-12 mt3 margin_auto">
                                <div className="col-md-4 bd_right" style={{ padding: '0 6%' }}>
                                    ...
                                    <h5 className="fgsd14 tt">Affordable</h5>
                                    <p className="ltr18" id="130"><sup>1</sup> </p>
                                </div>

                                <div className="col-md-4 bd_right" style={{ padding: '0 6%' }}>
                                    <div class="vl"></div>
                                    <img src={img2} alt="" width="175px" />
                                    <h5 className="fgsd14 tt">convenient</h5>
                                    <p className="ltr18" id="131"></p>
                                </div>

                                <div className="col-md-4" >
                                    <img src={img3} alt="" width="85px" />
                                    <h5 className="fgsd14 tt">guaranteed</h5>
                                    <p className="ltr18" id="132"></p>
                                </div>
                            </div>
...
const PageOneWithSocket = props => (
    <SocketContext.Consumer>
        {socket => <PageOne socket={socket} />}
    </SocketContext.Consumer>
)
export default PageOneWithSocket
