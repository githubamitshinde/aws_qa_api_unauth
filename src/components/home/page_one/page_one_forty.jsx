...
class PageOneIdForty extends Component {
    constructor() {
        super();
        this.state = {
                    ...
                    <div id="income_s" className="col-md-12 text-center section" style={{ backgroundColor: '#F9E038' }}>
                        <div className="container">
                            ...
                            <div className="col-md-8 col-md-offset-2">
                                <h4 className="ltr20" id="123">Innovative life insurance that provides your loved ones with reliable monthly income to replace your paycheck. It lets them focus on the future without worrying about managing money. </h4>
                            </div>
...
const PageOneIdFortyWithSocket = props => (
    <SocketContext.Consumer>
        {socket => <PageOneIdForty socket={socket} />}
    </SocketContext.Consumer>
)
export default PageOneIdFortyWithSocket