...
class PageOneIdTwenty extends Component {
    constructor() {
        super();
        this.state = {
                        ...
                        <div className="container">
                            ...
                            <div className="col-md-12 mt3 margin_auto">
                                ...
                                <div className="col-md-4" >
                                    ...
                                    <p className="ltr18" id="132">Guaranteed monthly income helps provide for your loved ones if you die while covered.. Payments to your family continue until year XXXX.</p>
                                </div>
                            </div>
...
const PageOneIdTwentyWithSocket = props => (
    <SocketContext.Consumer>
        {socket => <PageOneIdTwenty socket={socket} />}
    </SocketContext.Consumer>
)
export default PageOneIdTwentyWithSocket