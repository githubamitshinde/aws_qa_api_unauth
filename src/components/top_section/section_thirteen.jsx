...
import img_two from "../../images/SVG/down_arrow.svg"
import img_three from "../../images/SVG/down_arrow.svg"
...
const img_one = ApiList.base_cdn_src+"/images/188549073.jpg";
...
class SectionThirteen extends Component {
    ...
    componentDidMount() {
        ...
        $('.how_it_works').css('border-top','3px solid #00c3ff')
                ...
                <div className="col-md-12" style={{ color: 'black', backgroundColor: "#00C3FF" }}>
                    ...
                    <div className="container  mb2">
                        <div className="col-md-8 mt3 text-center bgimagetext">
                            {/* 106 STARTS HERE*/}
                            <div className="col-md-12 mt4 col-md-offset-0" style={{ color: "white", lineHeight: 1.0 }} id="">Innovative life insurance</div>
                            <div className="col-md-12 col-md-offset-0" style={{ color: "white", lineHeight: 1.0 }} id="">designed for today's families</div>
                            {/* 106 ENDS HERE */}
...
export default withRouter(SectionThirteen)
