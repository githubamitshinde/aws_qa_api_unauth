...
const img_one = ApiList.base_cdn_src + "/images/6117-08058128s (1).jpg";
...
// import { default as img_three, default as img_two } from "../../images/SVG/down_arrow.svg";
...
class SectionOne extends Component {
    ...
    componentDidMount() {
        $(document).ready(function () {
            $('input[type=text]:visible').map(function () {
                $(this).val('')
        ...
        var self = this
        console.log("BEFORE DROPDOWN CALLL:::::")
        // ############################## dropdown api #######################
        ...
        return new Promise(function (resolve, reject) {
            var body_data = {
                "agent_data": {
                    ...
                    "state": location_obj.state_cd
                }
            };

           console.log(ApiList.current.base_api_url + ApiList.agent.agent_eligible+" --- " + JSON.stringify(body_data))
            $.ajax({
                ...
                success: (data) => {
                    console.log("agent eligiblity--"+JSON.stringify(data))
    ...
    validate_form = () => {
        ...
        if (validation_flag == false || zipcode_flag == false) {
            $("#validation_section_one").css("display", 'block');
            setTimeout(function () {
                $("#validation_section_one").css("display", 'none');
            }, 4000);
    ...
    zipfetch = (zip) => {
        return new Promise(function (resolve, reject) {
            ...
            console.log(ApiList.current.base_api_url + ApiList.fetch_zip)
            // console.log(body_data)
            $.ajax({
                url: ApiList.current.base_api_url + ApiList.fetch_zip,
                type: 'POST',
                data: JSON.stringify(body_data),
                headers: {
                    'Content-Type': "application/json",
                ...
                error: function (err) {
                    console.log("ERROR in fetch zipcode  " + JSON.stringify(err));
                    reject()
    ...
    state_eligibility = (location) => {
        return new Promise(function (resolve, reject) {
            ...
            let user_data = JSON.parse(sessionStorage.getItem('user_data'));
            console.log(ApiList.current.base_afficient_api_url + ApiList.state_eligible)
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if (data.eligibility_flag == 1) {
                        user_data.city = location.city_nm ? location.city_nm : null

                        user_data.state = location.state_cd ? location.state_cd : null
                        user_data.country = location.country_cd ? location.country_cd : null
                        sessionStorage.setItem('user_data', JSON.stringify(user_data))
    ...
    render() {
        console.log('a', this.props.token);
        console.log('b', this.props.tokenA);
        return (
            <div>
                <div className="col-md-12 section_one" style={{ color: 'black', backgroundColor: "#00C3FF" }}>
                    ...
                    <div className="container  mb2">
                        <div className="col-md-8 mt3 text-center bgimagetext">
                            {/* 106 STARTS HERE*/}
                            <div className="col-md-8 mt4 col-md-offset-1" style={{ color: "white", lineHeight: 1.0 }} id="">Life insurance</div>
                            <div className="col-md-8 col-md-offset-1" style={{ color: "white", lineHeight: 1.0 }} id="">can’t replace you</div>
                            {/* 106 ENDS HERE */}
                            <div className="col-md-8 col-md-offset-1" style={{ color: "white", lineHeight: 1.0 }} id="107">But it can replace your monthly income.</div>
                        ...
                        <div className="col-md-4 mt3 col-xs-12 text-left quote_form">
                            ...
                            <div className="col-md-12 col-xs-12 mt5 mb3 text-center">
                                <button type="button" tabIndex="0" className="btn cbtn_color tt my_quote_submit scroll_to" id="116" onClick={this.handleClick}> <span tabIndex="-1">GET MY QUOTE</span> </button>
                            </div>
